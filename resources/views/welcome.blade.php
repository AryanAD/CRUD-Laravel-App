...
<head>
    ...
    <title>Laravel To-Do App - HomePage</title>
...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="flex items-center justify-between font-2xl mb-5">
                    <button
                        class="flex items-center justify-center gap-1 bg-[#321F2B] text-[#EF4444] px-4 py-2 rounded-lg font-['sf pro'] tracking-wider hover:-translate-y-1 hover:bg-[#18212F] hover:font-bold hover:transition-all hover:ease-in "
                        onclick="window.location.href='{{ route('teacher.index') }}'">
                        <span class="material-symbols-rounded">
                            person
                        </span>TEACHERS</button>
                </div>
